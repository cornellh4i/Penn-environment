    ...
    return (
      <View>
        <div className='App' style={{ width: '100%', left: '0%' }}>
          ...
          >
            Senate Bill {this.props.location.state.data.bill_number}
          </h2>
          <br></br>
          <h3
            style={{
          ...
          >
            Introduced on {this.props.location.state.data.bill_intro_date}
          </h3>
          <View style={styles.buttonsRow}>
            <Button
              ...
              onPress={() =>
                Linking.openURL(
                  'https://' + this.props.location.state.data.bill_pdf
                )
              }
            />
          </View>
          ...
          >
            {this.props.location.state.data.bill_summary}
          </h4>
        </div>
        ...
        <View style={styles.articles}>
          ...
          <Text style={styles.subTitles}>
            Related PennEnvironment Petitions
          </Text>
        ...
        <View style={styles.billTabArea}>
          ...
          <View style={styles.overviewRows}>
            ...
            <Text style={styles.tabInfoSponsor}>
              Senator {this.props.location.state.data.bill_sponsor}
            </Text>
          </View>
          <View style={styles.row}>
            <Text style={styles.subInfo}>
              Senate District {this.props.location.state.data.sponsor_district},{' '}
              {this.props.location.state.data.sponsor_party}
            </Text>
          </View>
          <View style={styles.row}>
            ...
            <Text style={styles.tabInfo}>
              {this.props.location.state.data.bill_cosponsor}
            </Text>
          </View>
          <View style={styles.row}>
            <Text style={styles.tabHeaders}>Updated Date: </Text>
            <Text style={styles.tabInfo}>
              {this.props.location.state.data.bill_updated}
            </Text>
          </View>
          <View style={styles.row}>
            <Text style={styles.tabHeaders}>Status: </Text>
            <Text style={styles.tabInfo}>
              {this.props.location.state.data.bill_status}
            </Text>
          </View>
          <View style={styles.row}>
            <Text style={styles.tabHeaders}>
              Memo: <br></br>
            </Text>
            <Text style={styles.tabInfo}>
              {this.props.location.state.data.bill_memo}
            </Text>
          </View>
        </View>
      </View>
